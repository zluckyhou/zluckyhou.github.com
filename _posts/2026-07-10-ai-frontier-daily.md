---
layout: daily
title: "AI Frontier Daily | 2026.07.10"
headline: "OpenAI 正式推出 GPT-5.6，Sol/Terra/Luna 同步进入 ChatGPT、Codex 与 API"
date: 2026-07-10 09:07:00 +0800
permalink: /ai-daily/2026/07/10/
categories: [ai-daily]
tags: [AI-Frontier, Daily]
description: "OpenAI 发布 GPT-5.6 系列，包含旗舰 Sol、平衡型 Terra 和低成本 Luna，并开始在 ChatGPT、Codex 与 API 中逐步推出。官方称 Sol 在 coding、knowledge work、cybersecurity 和 science 上提高了性能/成本比：Agents' Last Exam 得分 53.6，Artificial Analysis Coding Agent Index 达到 80.0，并用更少 output tokens、更短时间和更低估算成本超过若干竞品设置。GPT-5.6 同时引入 ultra mode，用多个 agent 并行处理复杂任务；Sam Altman 强调企业关心的 dollars-per-task 是这次发布的核心。"
summary: "OpenAI 发布 GPT-5.6 系列，包含旗舰 Sol、平衡型 Terra 和低成本 Luna，并开始在 ChatGPT、Codex 与 API 中逐步推出。官方称 Sol 在 coding、knowledge work、cybersecurity 和 science 上提高了性能/成本比：Agents' Last Exam 得分 53.6，Artificial Analysis Coding Agent Index 达到 80.0，并用更少 output tokens、更短时间和更低估算成本超过若干竞品设置。GPT-5.6 同时引入 ultra mode，用多个 agent 并行处理复杂任务；Sam Altman 强调企业关心的 dollars-per-task 是这次发布的核心。"
issue_count: 14
deep_dive_count: 6
reading_time: 22
cover: "https://scontent-sjc6-1.xx.fbcdn.net/v/t39.2365-6/741906678_873652302465180_7764547737953411008_n.png?_nc_cat=104&ccb=1-7&_nc_sid=e280be&_nc_ohc=OlBvaYygvIUQ7kNvwHlMxE6&_nc_oc=AdqVYFIkAyexygUeLoGxrbbSEEiOSz8dzcgbFIMA2e40aSJjQE4rdygbLcWJ7HxM5T2sz_VUtfZvnBtwTk7ZjLYa&_nc_zt=14&_nc_ht=scontent-sjc6-1.xx&_nc_gid=xg7bMn4AID8zXwYz3Trs3A&_nc_ss=7920f&oh=00_AQBFAuz_IQBaDp3zSanm_3nEFoCfzRP-6ite3UovSEt_NQ&oe=6A6AC7A6"
signals: "OpenAI · sama · gdb · satyanadella · AIatMeta · perplexity_ai · cursor_ai · bindureddy"
...
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075271421149020426)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075271422545703003)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075271423992680532)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075271425548795909)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075271427079774451)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075271435573244008)
- [查看 @sama 原始推文](https://x.com/sama/status/2075267201058426944)
...
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075274271845404744)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075274273607037403)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075274275104399670)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2075274276849226204)
- [查看 @gdb 原始推文](https://x.com/gdb/status/2075276416686723110)
- [查看 @sama 原始推文](https://x.com/sama/status/2075293792048136572)
...
- [查看 @satyanadella 原始推文](https://x.com/satyanadella/status/2075318015063925053)
- [查看 @satyanadella 原始推文](https://x.com/satyanadella/status/2075318017068863653)
...
- [查看 @AIatMeta 原始推文](https://x.com/AIatMeta/status/2075221095880565096)
- [查看 @AIatMeta 原始推文](https://x.com/AIatMeta/status/2075221097579233687)
- [查看 @AIatMeta 原始推文](https://x.com/AIatMeta/status/2075221099961516500)
- [查看 @AIatMeta 原始推文](https://x.com/AIatMeta/status/2075221102172016989)
- [查看 @AIatMeta 原始推文](https://x.com/AIatMeta/status/2075226305633956003)
- [查看 @AIatMeta 原始推文](https://x.com/AIatMeta/status/2075307298432676259)
...
- [查看 @perplexity_ai 原始推文](https://x.com/perplexity_ai/status/2075224548476440779)
- [查看 @perplexity_ai 原始推文](https://x.com/perplexity_ai/status/2075224565048082502)
- [查看 @perplexity_ai 原始推文](https://x.com/perplexity_ai/status/2075229779716973030)
...
- [查看 @cursor_ai 原始推文](https://x.com/cursor_ai/status/2075265504105611674)
- [查看 @cursor_ai 原始推文](https://x.com/cursor_ai/status/2075265505229730048)
- [查看 @perplexity_ai 原始推文](https://x.com/perplexity_ai/status/2075375851479420951)
- [查看 @bindureddy 原始推文](https://x.com/bindureddy/status/2075295728373833801)
- [查看 @bindureddy 原始推文](https://x.com/bindureddy/status/2075269281701654745)
...
- [查看 @emollick 原始推文](https://x.com/emollick/status/2075345621716730049)
- [查看 @emollick 原始推文](https://x.com/emollick/status/2075360888375120152)
- [查看 @mattshumer_ 原始推文](https://x.com/mattshumer_/status/2075267773458940306)
- [查看 @mattshumer_ 原始推文](https://x.com/mattshumer_/status/2075268746315268138)
- [查看 @mattshumer_ 原始推文](https://x.com/mattshumer_/status/2075293578826240374)
...
- [查看 @AnthropicAI 原始推文](https://x.com/AnthropicAI/status/2075257492716879967)
...
- [查看 @NVIDIAAI 原始推文](https://x.com/NVIDIAAI/status/2075330188464779686)
- [查看 @NVIDIAAI 原始推文](https://x.com/NVIDIAAI/status/2075330191157518589)
- [查看 @NVIDIAAI 原始推文](https://x.com/NVIDIAAI/status/2075330215694442630)
...
- [查看 @pika_labs 原始推文](https://x.com/pika_labs/status/2075270820407247295)
- [查看 @pika_labs 原始推文](https://x.com/pika_labs/status/2075270822298779826)
- [查看 @pika_labs 原始推文](https://x.com/pika_labs/status/2075270823779406075)
- [查看 @pika_labs 原始推文](https://x.com/pika_labs/status/2075270825415160199)
- [查看 @pika_labs 原始推文](https://x.com/pika_labs/status/2075270827000664074)
- [查看 @pika_labs 原始推文](https://x.com/pika_labs/status/2075342772396323293)
- [查看 @pika_labs 原始推文](https://x.com/pika_labs/status/2075342773675581688)
...
- [查看 @runwayml 原始推文](https://x.com/runwayml/status/2075244036986740987)
- [查看 @runwayml 原始推文](https://x.com/runwayml/status/2075244038383345934)
...
- [查看 @mustafasuleyman 原始推文](https://x.com/mustafasuleyman/status/2075131152663241036)
- [查看 @mustafasuleyman 原始推文](https://x.com/mustafasuleyman/status/2075131371484230104)
- [查看 @emollick 原始推文](https://x.com/emollick/status/2075267042765148237)
...
- [查看 @suno 原始推文](https://x.com/suno/status/2075232707001368707)
- [查看 @suno 原始推文](https://x.com/suno/status/2075232708989522387)
- [查看 @suno 原始推文](https://x.com/suno/status/2075232711090835939)
- [查看 @suno 原始推文](https://x.com/suno/status/2075232712529481850)
- [查看 @suno 原始推文](https://x.com/suno/status/2075232713913532469)
...
- [查看 @ylecun 原始推文](https://x.com/ylecun/status/2075102766221996136)
- [查看 @AndrewYNg 原始推文](https://x.com/AndrewYNg/status/2075271586400403567)
- [查看 @ClementDelangue 原始推文](https://x.com/ClementDelangue/status/2075294232001093977)
- [查看 @ClementDelangue 原始推文](https://x.com/ClementDelangue/status/2075194062085279907)
- [查看 @ClementDelangue 原始推文](https://x.com/ClementDelangue/status/2075194105991135641)
- [查看 @ClementDelangue 原始推文](https://x.com/ClementDelangue/status/2075097247134392818)
...
Perplexity 的新 orchestrator model 把 agent cost engineering 推到前台。官方称该模型基于 GLM 5.2 并为 Computer harness post-trained，提供 near-frontier performance，成本为 Opus 的 0.344x；其 advisor tool 会在需要时自动升级到更强模型。这个结构不同于单一模型替换，而是将“何时使用便宜模型、何时升级强模型”产品化。Perplexity 后续还用 WANDR 成本对比说明 GLM 5.2 + advisor 和 Opus 的成本差异，显示 Computer 这样的 agent 产品正在把 routing、advisor、GPU 托管和 benchmark reporting 作为核心卖点。
[查看原文](https://x.com/perplexity_ai/status/2075224548476440779)

### NVIDIA Flex-Forcing
Flex-Forcing 试图统一视频生成里的两种推理范式。Bidirectional diffusion 更擅长保持整体结构，因为它可同时关注多个帧；autoregressive generation 更适合 streaming 和长视频，因为它逐帧推进，但可能随时间漂移。NVIDIA 的方法用 flexible chunking 同时控制 temporal dimension 与 denoising steps，使同一模型能在推理时选择偏结构一致、偏速度/长度，或二者之间的混合路径。它的重要性在于，视频生成正在从“单段视频是否好看”转向“能否按预算、长度、连贯性和交互需求选择生成策略”。
[查看原文](https://research.nvidia.com/labs/genair/flex-forcing/)

### Anthropic Long-Term Benefit Trust / Bernanke
Anthropic 任命 Ben Bernanke 加入 Long-Term Benefit Trust，把 advanced AI governance 与宏观经济经验直接连接。Anthropic 称 LTBT 是独立机构，负责帮助公司在商业目标与长期人类利益之间保持平衡，并可向董事会和管理层就 AI 风险、社会影响和关键决策提供建议。Bernanke 的背景覆盖中央银行、金融危机、宏观经济研究和制度应对，这与 Anthropic 当前强调的 AI 对 workforce、economies 和 institutions 的影响相匹配。这条消息不是产品发布，但说明 frontier labs 争夺的不只是模型能力，也包括可信治理结构和社会影响判断。
