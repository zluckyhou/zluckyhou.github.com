...
SpaceX 宣布与 AI 编程工具 Cursor 建立深度战略合作，并持有今年晚些时候以 600 亿美元收购 Cursor 的期权（或向 Cursor 支付 100 亿美元作为合作报酬）。双方将合并 Cursor 在顶级工程师中的产品分发优势，以及 SpaceX Colossus 超算（相当于 100 万块 H100 算力）进行联合模型训练。Cursor 已基于 xAI Colossus 基础设施训练其 Composer 系列模型，从 Composer 1.5 迭代至 Composer 2，每次算力升级均带来明显能力提升。该交易中，SpaceX 与 xAI 已于 2026 年 2 月合并（整体估值 1.25 万亿美元）。值得注意的是，目前 Cursor 仍依赖 Claude 和 GPT 等第三方模型，而 Anthropic 和 OpenAI 都在推出自己的编程工具，此次合作或是 Cursor 摆脱依赖的关键一步。
- [查看 @SpaceX 原始推文](https://x.com/SpaceX/status/2046713419978453374)
- [查看 @xai 原始推文](https://x.com/xai/status/2046717120428351809)
...
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2046691653453562341)
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2046691651767476579)
- [查看 @emollick 原始推文](https://x.com/emollick/status/2046728271849550331)
...
- [查看 @sundarpichai 原始推文](https://x.com/sundarpichai/status/2046627545333080316)
...
- [查看 @Kimi_Moonshot 原始推文](https://x.com/Kimi_Moonshot/status/2046531057147933137)
- [查看 @Kimi_Moonshot 原始推文](https://x.com/Kimi_Moonshot/status/2046531052957569211)
...
- [查看 @Kimi_Moonshot 原始推文](https://x.com/Kimi_Moonshot/status/2046607915424034839)
...
- [查看 @windsurf 原始推文](https://x.com/windsurf/status/2046686574793154996)
...
- [查看 @databricks 原始推文](https://x.com/databricks/status/2046606330782236710)
...
- [查看 @databricks 原始推文](https://x.com/databricks/status/2046638879894020223)
...
- [查看 @scale_AI 原始推文](https://x.com/scale_AI/status/2046661276357857429)
...
- [查看 @Replit 原始推文](https://x.com/Replit/status/2046665322661372069)
- [查看 @Replit 原始推文](https://x.com/Replit/status/2046667308571967644)
...
- [查看 @ClementDelangue 原始推文](https://x.com/ClementDelangue/status/2046766920100110753)
- [查看 @ClementDelangue 原始推文](https://x.com/ClementDelangue/status/2046762314766934350)
...
- [查看 @mustafasuleyman 原始推文](https://x.com/mustafasuleyman/status/2046639343624991191)
...
- [查看 @hwchase17 原始推文](https://x.com/hwchase17/status/2046771388137328913)
...
- [查看 @sundarpichai 原始推文](https://x.com/sundarpichai/status/2046682795112800308)
...
- [查看 @cohere 原始推文](https://x.com/cohere/status/2046742203758694510)
...
- [查看 @SakanaAILabs 原始推文](https://x.com/SakanaAILabs/status/2046734193305280940)
...
- [查看 @llama_index 原始推文](https://x.com/llama_index/status/2046586730879283227)
...
[查看原文](https://cursor.com/blog/spacex-model-training)
[查看原文](https://techcrunch.com/2026/04/21/spacex-is-working-with-cursor-and-has-an-option-to-buy-the-startup-for-60-billion/)
[查看原文](https://www.cnbc.com/2026/04/21/spacex-says-it-can-buy-cursor-later-this-year-for-60-billion-or-pay-10-billion-for-our-work-together.html)
...
[查看原文](https://blog.google/innovation-and-ai/models-and-research/gemini-models/next-generation-gemini-deep-research/)
[查看原文](https://the-decoder.com/google-launches-deep-research-and-deep-research-max-agents-to-automate-complex-research/)

### OpenAI ChatGPT Images 2.0：图像生成进入推理时代
OpenAI 于 4 月 21 日发布 ChatGPT Images 2.0（底层模型：gpt-image-2），最大突破是引入"思考模式"——模型在生成前会先推理、联网搜索、生成多个候选并自我核验。主要能力提升：精确多语言文字渲染（包括中文、阿拉伯文等非拉丁文字）、专业幻灯片和信息图生成（支持数据可视化布局）、多宽高比与分辨率控制、大幅提升的指令遵循精度。研究者 Ethan Mollick 实测显示其在书籍封面生成、数据图表制作方面已接近专业设计水平，但多轮编辑稳定性仍有不足（建议新对话重新开始而非在原对话继续修改）。标准版对所有用户开放，思考模式限付费订阅者，API 同步开放。
[查看原文](https://openai.com/index/introducing-chatgpt-images-2-0/)
