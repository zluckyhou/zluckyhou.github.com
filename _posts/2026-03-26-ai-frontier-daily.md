---
layout: daily
title: "AI Frontier Daily | 2026.03.26"
headline: "ARC-AGI-3 发布：全球唯一未被攻克的 Agentic AI 基准"
date: 2026-03-26 09:07:00 +0800
permalink: /ai-daily/2026/03/26/
categories: [ai-daily]
tags: [AI-Frontier, Daily]
description: "François Chollet 宣布 ARC-AGI-3 正式发布，这是首个测试 AI 代理交互式推理能力的基准测试，也是目前世界上唯一未饱和的 Agentic 智能基准。与前两代侧重静态推理不同，ARC-AGI-3 要求 AI 在没有任何指令和目标的情况下，通过探索陌生环境自主学习规则。人类得分 100%，而所有前沿 AI 模型得分均低于 1%。包含 1000+ 关卡、150+ 环境，评分指标为\"动作效率\"——衡量 AI 与人类相比，多快能将环境信息转化为有效策略。ARC Prize 为此专门组建了一个游戏工作室来开发这套测试系统。"
summary: "François Chollet 宣布 ARC-AGI-3 正式发布，这是首个测试 AI 代理交互式推理能力的基准测试，也是目前世界上唯一未饱和的 Agentic 智能基准。与前两代侧重静态推理不同，ARC-AGI-3 要求 AI 在没有任何指令和目标的情况下，通过探索陌生环境自主学习规则。人类得分 100%，而所有前沿 AI 模型得分均低于 1%。包含 1000+ 关卡、150+ 环境，评分指标为\"动作效率\"——衡量 AI 与人类相比，多快能将环境信息转化为有效策略。ARC Prize 为此专门组建了一个游戏工作室来开发这套测试系统。"
issue_count: 16
deep_dive_count: 4
reading_time: 14
cover: "https://storage.googleapis.com/gweb-uniblog-publish-prod/images/Lyria-3-Pro_thumbnail.width-1300.png"
signals: "fchollet · SakanaAILabs · hardmaru · GaryMarcus · bindureddy · AnthropicAI · GoogleDeepMind · OfficialLoganK"
...
- [查看 @fchollet 原始推文](https://x.com/fchollet/status/2036861192619384989)
- [查看 @fchollet 原始推文](https://x.com/fchollet/status/2036863769981403497)
- [查看 @fchollet 原始推文](https://x.com/fchollet/status/2036866189587271797)
...
- [查看 @SakanaAILabs 原始推文](https://x.com/SakanaAILabs/status/2036840833690071450)
- [查看 @hardmaru 原始推文](https://x.com/hardmaru/status/2036841736702767135)
...
- [查看 @GaryMarcus 原始推文](https://x.com/GaryMarcus/status/2036630797147386251)
- [查看 @bindureddy 原始推文](https://x.com/bindureddy/status/2036680264777449774)
...
- [查看 @AnthropicAI 原始推文](https://x.com/AnthropicAI/status/2036944806317088921)
...
- [查看 @GoogleDeepMind 原始推文](https://x.com/GoogleDeepMind/status/2036836176233918707)
- [查看 @OfficialLoganK 原始推文](https://x.com/OfficialLoganK/status/2036848277333622956)
- [查看 @demishassabis 原始推文](https://x.com/demishassabis/status/2036901597343838434)
...
- [查看 @elonmusk 原始推文](https://x.com/elonmusk/status/2036803390551056759)
- [查看 @elonmusk 原始推文](https://x.com/elonmusk/status/2036888086618267696)
- [查看 @elonmusk 原始推文](https://x.com/elonmusk/status/2036884267234644393)
...
- [查看 @elonmusk 原始推文](https://x.com/elonmusk/status/2036889456142397808)
...
- [查看 @demishassabis 原始推文](https://x.com/demishassabis/status/2036726283464581343)
...
- [查看 @karpathy 原始推文](https://x.com/karpathy/status/2036836816654147718)
...
- [查看 @LumaLabsAI 原始推文](https://x.com/LumaLabsAI/status/2036941196262543458)
- [查看 @LumaLabsAI 原始推文](https://x.com/LumaLabsAI/status/2036926112983638473)
- [查看 @LumaLabsAI 原始推文](https://x.com/LumaLabsAI/status/2036914579692019932)
...
- [查看 @hwchase17 原始推文](https://x.com/hwchase17/status/2036860332501852227)
...
- [查看 @demishassabis 原始推文](https://x.com/demishassabis/status/2036702876299665846)
- [查看 @databricks 原始推文](https://x.com/databricks/status/2036815401569362137)
...
- [查看 @LisaSu 原始推文](https://x.com/LisaSu/status/2036850461597151332)
...
- [查看 @mustafasuleyman 原始推文](https://x.com/mustafasuleyman/status/2036836378101830029)
...
- [查看 @togethercompute 原始推文](https://x.com/togethercompute/status/2036932786049692141)
...
- [查看 @OpenAI 原始推文](https://x.com/OpenAI/status/2036855694906057079)
...
Chollet 强调：ARC-AGI-3 不是判断 AGI 的"期末考试"，而是追踪 AGI 进展的工具——任何在排行榜上的突然跃升，都将意味着 AGI 领域真正的突破。
...
关键数据：AI Scientist-v2 在 ICLR 2025 研讨会上提交论文，平均评分 6.33（高于 55% 人类投稿）。配套的自动审稿人达到 69% 均衡准确率。论文质量与底层基础模型能力呈正相关，意味着随模型迭代，系统能力将持续提升。局限：仍主要在计算实验领域运作，存在方法论不严格、幻觉引用等问题。团队已为 AI 生成论文加水印并撤回已接收稿件，体现负责任开发理念。
...
效果：误报率 0.4%（人工审批的替代达成率极高），但对"越权行为"漏检率 17%，对合成数据泄露漏检 5.7%。定位：不替代高风险基础设施上的人工审查，仅替代"反正都会批"的疲劳审批场景。
[查看原文](https://www.anthropic.com/engineering/claude-code-auto-mode)
...
发布范围全面覆盖：Gemini App（付费用户优先）、Gemini API 公开预览（开发者）、Google AI Studio、Google Vids（Workspace 用户）、Vertex AI（企业大规模音频生成）。所有生成内容均带 SynthID 水印。相较于 Suno，Lyria 最大差异化优势在于：无版权争议（Suno 因训练数据问题持续面临版权诉讼），且开放 API 访问，可嵌入第三方产品。
[查看原文](https://blog.google/innovation-and-ai/technology/ai/lyria-3-pro/)
