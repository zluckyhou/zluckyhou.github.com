---
layout: daily
title: "AI Frontier Daily | 2026.04.18"
headline: "xAI 正式发布 Grok 4.3 Beta"
date: 2026-04-18 09:07:00 +0800
permalink: /ai-daily/2026/04/18/
categories: [ai-daily]
tags: [AI-Frontier, Daily]
description: "Elon Musk 宣布 Grok 4.3 进入早期公测阶段，并向所有用户免费开放 48 小时。新版本新增多项文件创建能力，包括生成幻灯片、电子表格、PDF 及 Word 文档，同时支持视频输入与音频提取。Elon 强调这是\"better-than-nothing early beta\"，将快速迭代更新。xAI 团队今天的推广力度极大，Grok 4.3 系列推文单条阅读量突破 200 万。"
summary: "Elon Musk 宣布 Grok 4.3 进入早期公测阶段，并向所有用户免费开放 48 小时。新版本新增多项文件创建能力，包括生成幻灯片、电子表格、PDF 及 Word 文档，同时支持视频输入与音频提取。Elon 强调这是\"better-than-nothing early beta\"，将快速迭代更新。xAI 团队今天的推广力度极大，Grok 4.3 系列推文单条阅读量突破 200 万。"
issue_count: 18
deep_dive_count: 3
reading_time: 12
cover: "https://d3phaj0sisr2ct.cloudfront.net/site/images/news/rw_nvidia_blog.png"
signals: "elonmusk · xai · emollick · LinusEkenstam · gdb · cursor_ai · bindureddy · sama"
...
- [查看 @elonmusk 原始推文](https://x.com/elonmusk/status/2045285099680252417)
- [查看 @xai 原始推文](https://x.com/xai/status/2045297699352924504)
...
- [查看 @elonmusk 原始推文](https://x.com/elonmusk/status/2045293644693770630)
...
- [查看 @emollick 原始推文](https://x.com/emollick/status/2045147490316374414)
- [查看 @emollick 原始推文](https://x.com/emollick/status/2044966818339594252)
...
- [查看 @LinusEkenstam 原始推文](https://x.com/LinusEkenstam/status/2045223618368487444)
- [查看 @LinusEkenstam 原始推文](https://x.com/LinusEkenstam/status/2045214853590081693)
...
- [查看 @gdb 原始推文](https://x.com/gdb/status/2045214436689072136)
- [查看 @gdb 原始推文](https://x.com/gdb/status/2045227305816281404)
- [查看 @cursor_ai 原始推文](https://x.com/cursor_ai/status/2045236540784492845)
...
- [查看 @bindureddy 原始推文](https://x.com/bindureddy/status/2045236872230899834)
- [查看 @sama 原始推文](https://x.com/sama/status/2045232470917022162)
...
- [查看 @GoogleDeepMind 原始推文](https://x.com/GoogleDeepMind/status/2045118463010545688)
...
- [查看 @databricks 原始推文](https://x.com/databricks/status/2045209450085040507)
...
- [查看 @databricks 原始推文](https://x.com/databricks/status/2045156436536139909)
...
- [查看 @runwayml 原始推文](https://x.com/runwayml/status/2045174850856034702)
- [查看 @runwayml 原始推文](https://x.com/runwayml/status/2045140613247496316)
...
- [查看 @rowancheung 原始推文](https://x.com/rowancheung/status/2045158931367072104)
- [查看 @rowancheung 原始推文](https://x.com/rowancheung/status/2045158943287283986)
...
- [查看 @AlphaSignalAI 原始推文](https://x.com/AlphaSignalAI/status/2045110450166067598)
...
- [查看 @Replit 原始推文](https://x.com/Replit/status/2045193641036239090)
...
- [查看 @elonmusk 原始推文](https://x.com/elonmusk/status/2044990537145753894)
...
- [查看 @emollick 原始推文](https://x.com/emollick/status/2045305504679842279)
- [查看 @emollick 原始推文](https://x.com/emollick/status/2045307368993374597)
...
- [查看 @ClementDelangue 原始推文](https://x.com/ClementDelangue/status/2045184409704288476)
...
随着企业内 Cursor、Gemini CLI、Codex 等工具并存，Databricks 识别出三大核心问题：安全风险（MCP 可能使 Agent 成为组织内权限最高的开发者，访问敏感数据）、成本爆炸（AI 工具成本正成为研发最大支出之一）、可视性盲区（管理层无法追踪各团队实际使用情况）。Unity AI Gateway 解决方案：统一安全审计（所有 MCP 访问集中追踪，日志存入 Unity Catalog）、统一成本管理（支持 OpenAI/Anthropic/Gemini 等主流模型，管理员可设置跨工具总费用上限）、全面可观测性（按部门追踪采用率，关联 AI 工具使用与业务产出）。官方声明目标是"在提升 AI 生产力的同时确保数据隐私和成本可视性"。
[查看原文](https://www.databricks.com/blog/governing-coding-agent-sprawl-unity-ai-gateway)

### Databricks Genie Agent Mode：数据分析师式多步推理
传统 Genie 返回单次查询结果，Agent Mode 则模拟完整分析师工作流：接收复杂问题（如"为何 Q3 流失率飙升"）→ 制定分析计划 → 提出假设 → 多轮查询验证 → 迭代推理 → 生成含图表和 SQL 引用的综合报告。系统会根据问题复杂度动态调整推理深度，简单问题快速响应，复杂问题深入分析。透明度方面，所有分析过程对用户完全可见，可验证底层数据和逻辑。目前已集成到 Genie 空间和 AI/BI Dashboard 中。
[查看原文](https://www.databricks.com/blog/introducing-genie-agent-mode)

### xAI Grok 4.3 Beta：功能概览
Grok 4.3 本次更新重点在于扩展文档生成能力（幻灯片、电子表格、PDF、Word）和多媒体处理（视频输入、音频提取），Elon 本人和 xAI 官方账号集中发布多条推文展示功能演示。Elon 反复强调"这只是早期 Beta，每天都在改进"，设定预期管理。48 小时免费开放是典型的流量拉新策略。与此同时，xAI 还推出了独立的 Speech-to-Text API（25 语言，多说话人，市场最低定价），以及透露中的 1T 参数模型将在约 5 天后完成初始训练。三项消息同日发布，显示 xAI 正在进行一次集中的产品节奏冲刺。
[查看原文](https://x.com/elonmusk/status/2045285099680252417)
