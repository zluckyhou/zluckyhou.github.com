---
layout: daily
title: "AI Frontier Daily | 2026.06.15"
headline: "Sakana AI 正式推出首个商用产品 Sakana Marlin"
date: 2026-06-15 09:07:00 +0800
permalink: /ai-daily/2026/06/15/
categories: [ai-daily]
tags: [AI-Frontier, Daily]
description: "Sakana AI 宣布正式提供 Sakana Marlin，这是其首个商用产品，定位为面向企业的自律型研究助手。Marlin 可围绕用户给定主题进行最长约 8 小时的自主调研，输出结构化摘要幻灯片和数十页报告，目标是承担 CSO 与小团队通常需要数周完成的战略研究。Sakana 称该产品建立在长期推理、AB-MCTS 多模型协同搜索和 AI Scientist 工作流自动化经验之上，并提供 pay-per-use、Pro、Team、Enterprise 等计划。这个发布把 Sakana 从研究 lab 推向垂直企业 agent 市场。"
summary: "Sakana AI 宣布正式提供 Sakana Marlin，这是其首个商用产品，定位为面向企业的自律型研究助手。Marlin 可围绕用户给定主题进行最长约 8 小时的自主调研，输出结构化摘要幻灯片和数十页报告，目标是承担 CSO 与小团队通常需要数周完成的战略研究。Sakana 称该产品建立在长期推理、AB-MCTS 多模型协同搜索和 AI Scientist 工作流自动化经验之上，并提供 pay-per-use、Pro、Team、Enterprise 等计划。这个发布把 Sakana 从研究 lab 推向垂直企业 agent 市场。"
issue_count: 12
deep_dive_count: 7
reading_time: 18
cover: "https://sakana.ai/assets/marlin/ogp.png"
signals: "SakanaAILabs · hardmaru · togethercompute · satyanadella · swyx · mustafasuleyman · databricks · cohere"
...
### Sakana Marlin
Sakana Marlin 是 Sakana AI 的首个商用产品，正式版本面向企业战略、业务企划、金融机构、咨询、智库和调研公司等高强度研究场景。它的产品承诺是：用户输入调研主题后，系统自主提出假设、收集信息、验证和组织结论，最长运行约 8 小时，最终交付结构化 summary slides 与数十页报告。Sakana 将其技术基础归结为长期推理、AB-MCTS 多模型协同搜索和 AI Scientist 工作流自动化。与通用 deep research 产品相比，Marlin 更强调“像虚拟 CSO 一样做战略调研”，并通过 pay-per-use、Pro、Team、Enterprise 等计划进入商业化。它也是 Sakana 从研究成果到日本企业落地的一次关键产品化尝试。
[查看原文](https://sakana.ai/marlin-release/)

### Serving DeepSeek-V4
Together AI 的 DeepSeek V4 serving 文章强调，V4 的核心不是“能否支持 1M token context”这个静态规格，而是长上下文如何被推理系统实际承载。V4 的 CSA、HCA、SWA 混合注意力会产生不同尺寸、生命周期和访问模式的 KV cache；推理引擎必须分别处理 cache layout、prefix caching、local state recovery、batching 和 endpoint profile。Together 称在 NVIDIA HGX B200 bring-up 中，通过保留最可能复用的 SWA state，单节点 KV-cache capacity 从约 1.2M token 提高到 3.7M token。这对 200K-500K token 的 coding/research agent、RL rollout 和长任务轨迹尤其重要，因为成本模型会从每 token 价格转向完成整条 trajectory 的成本。
[查看原文](https://www.together.ai/blog/serving-deepseek-v4-why-million-token-context-is-an-inference-systems-problem)

### Agent-Native Research Artifacts
《The Last Human-Written Paper》提出，传统论文的线性 narrative 会产生 Storytelling Tax 和 Engineering Tax：失败实验、被否定假设、探索分支和精确实现细节被压缩或省略，导致 AI agent 难以理解、复现和扩展研究。作者提出 ARA 协议，用 scientific logic、executable code、exploration graph、evidence grounding 四层结构组织研究成果，并配套 Live Research Manager、ARA Compiler 和 ARA-native review system。实验显示，ARA 在 PaperBench/RE-Bench 上将问答准确率从 72.4% 提高到 93.7%，复现成功率从 57.4% 提高到 64.4%。这篇论文的信号是：AI for science 的瓶颈不只是更强模型，还包括研究输出格式是否为 agent-native。
[查看原文](https://arxiv.org/abs/2604.24658)

### When Does LeJEPA Learn a World Model?
LeJEPA 论文试图回答 world model 研究里的基本问题：一个 joint-embedding predictive model 到底是在学真实 world structure，还是只学到有用但混乱的压缩表示。作者证明，在 stationary additive-noise transitions 的一类世界中，LeJEPA 的 alignment 加 Gaussian regularization 可以线性恢复 latent variables；更强的是，Gaussian 是该保证成立的唯一 latent distribution。论文还给出 approximate identifiability，并说明 orthogonal identifiability 如何支持 optimal latent-space planning。实验从 2D 到 1024 维 latent，并包含 pixel-based robotic control。它的现实含义是，数据采样策略和 latent distribution 不是训练细节，而是决定 world model 是否可用于可靠规划的前提。
[查看原文](https://arxiv.org/abs/2605.26379)

### North Mini Code
Cohere 的 North Mini Code 是 30B total、3B active 的 MoE coding model，Apache 2.0 发布，面向 code generation、agentic software engineering 和 terminal tasks。官方规格包括 256K context、64K max generation、最低 1x H100 FP8，可通过 Hugging Face weights、Cohere API、Model Vault 和 OpenRouter 使用。Cohere 将其包装为 sovereign developer ecosystem 的第一步：开发者和企业可以在本地、on-prem 或托管环境中运行 coding agent，不必完全依赖 proprietary subscription。官方称其 Artificial Analysis Coding Index 为 33.4，并在内部测试中相对 Devstral Small 2 获得最高 2.8x output throughput。这个发布与 Cohere 关于“技术应由使用者拥有和控制”的叙事紧密相连。
[查看原文](https://cohere.com/blog/north-mini-code)

### Data + AI Summit 2026
Databricks Data + AI Summit 2026 于 6 月 15-18 日举办，官网称会议覆盖 800+ sessions、keynotes、training 和 meetups，主题包括 agentic AI systems、data-intelligent apps、Delta Lake、Apache Iceberg、Apache Spark、MLflow、Unity Catalog、Lakeflow、Databricks Apps、Databricks SQL、Lakebase、AI/BI 和开源框架。官方 speaker list 包含 Databricks CEO Ali Ghodsi、Microsoft CEO Satya Nadella（预录）、OpenAI President Greg Brockman，以及 NVIDIA、Replit、LangChain、Anthropic、Reliance 等代表。作为本周企业 AI 基础设施集中发布窗口，它值得跟踪的不是单场会议本身，而是 Databricks 会如何把 lakehouse、governance、agent skill、应用开发和开放协议整合成企业 AI platform。
[查看原文](https://www.databricks.com/dataaisummit)

### A frontier without an ecosystem is not stable
Nadella 的文章把 AI 时代企业竞争力描述为 human capital 与 token capital 的复利系统。Human capital 包含人的知识、判断、关系、创造力和模式识别；token capital 则是企业实际构建和拥有的 AI capability。关键论点是：AI 模型会不断吸收和商品化人类与组织专业知识，因此企业不能只租用单一通用模型，而要建立可持续学习的 agentic systems，让人类反馈、任务轨迹、评价体系、私有知识和模型能力形成 cognitive loop。这个观点把“frontier model”降级为可替换组件，把“frontier ecosystem”定义为真正稳定的企业 AI 架构。
[查看原文](https://x.com/satyanadella/article/2066182223213293753)
